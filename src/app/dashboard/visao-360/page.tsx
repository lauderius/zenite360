                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 mb-8">
                    ...
                    <Card className="lg:col-span-2 glass-card border-none rounded-3xl overflow-hidden">
                        ...
                        <CardContent className="h-[300px] flex items-end justify-between gap-4 px-4 pb-2">
                            <ChartBar label="Emergência" value={12} total={50} color="bg-red-500" />
                            <ChartBar label="M. Urgente" value={28} total={50} color="bg-orange-500" />
                            <ChartBar label="Urgente" value={45} total={50} color="bg-amber-500" />
                            <ChartBar label="Pouco Urg." value={30} total={50} color="bg-emerald-500" />
                            <ChartBar label="Não Urg." value={5} total={50} color="bg-sky-500" />
                        </CardContent>
                    </Card>
                    ...
                    <Card className="glass-card border-none rounded-3xl overflow-hidden">
                        ...
                        <CardContent className="p-0">
                            <div className="divide-y divide-white/5">
                                <ActivityItem
                                    title="Triagem Concluída - Paciente #4920"
                                    time="Há 2 min"
                                    description={<span className="text-orange-500 font-bold">Laranja (Muito Urgente)</span>}
                                    icon={<div className="p-2 rounded-xl bg-orange-500/10 text-orange-500"><Activity className="w-4 h-4" /></div>}
                                />
                                <ActivityItem
                                    title="Alerta de Stock Crítico"
                                    time="Há 15 min"
                                    description="Amoxicilina 500mg - Restam 12 un."
                                    icon={<div className="p-2 rounded-xl bg-red-500/10 text-red-500"><AlertCircle className="w-4 h-4" /></div>}
                                />
                                <ActivityItem
                                    title="Nova Admissão - Pediatria"
                                    time="Há 32 min"
                                    description="Dr. António Silva autorizou a admissão."
                                    icon={<div className="p-2 rounded-xl bg-emerald-500/10 text-emerald-500"><Users className="w-4 h-4" /></div>}
                                />
                            </div>
                        </CardContent>
                    </Card>
